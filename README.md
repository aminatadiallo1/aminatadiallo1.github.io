...
Passionnée par l'intelligence artificielle et la science des données, je développe des solutions alliant rigueur mathématique et impact concret. Mon parcours couvre le Machine Learning, le Deep Learning, l'IA générative et la cybersécurité.
Disponible **immédiatement** pour un stage et pour une **alternance de 12 mois** à partir de septembre 2026 en Île-de-France.
...
**Domaines**  
`Machine Learning` `Deep Learning` `IA Générative` `LLM` `IA Agentique` `MCP` `Cybersécurité`
...
[![Email](https://img.shields.io/badge/Email-contact-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:aminatadiallopro10@email.com)
